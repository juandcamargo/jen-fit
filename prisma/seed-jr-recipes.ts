...
// (isGlobal: true, userId: null) visible to every account. Nutrition values
// below are typical per-100g figures (USDA-style) for each raw ingredient —
// the app computes each recipe's real macros by summing ingredient
// contributions, same as any user-created recipe.
